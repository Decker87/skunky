class Skunky < Formula
  ...
  # At some point we will still need to do `brew services start mysql` at least once
  service do
    run opt_bin/"skunky-indexer"
    log_path var/"log/skunky-indexer.log"
    error_log_path var/"log/skunky-indexer.log"
    keep_alive true
  end
